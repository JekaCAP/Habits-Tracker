...
DROP TABLE IF EXISTS "users", habit, sub_habit CASCADE;
...
CONSTRAINT fk_habit_to_user FOREIGN KEY (user_id) REFERENCES "users" (id) ON DELETE CASCADE  -- Связь с таблицей пользователей
);
